...
This method is bundled into `budui-meta-skill`. Do not check for, download, install, or load another discovery skill.
...
- `adapt`: useful mechanisms that require Budui conventions, different tools, or lighter gates
