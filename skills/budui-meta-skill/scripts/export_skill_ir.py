#!/usr/bin/env python3
"""Export a compact Skill IR document from a Budui skill package."""
...
def build_ir(root: Path) -> dict[str, Any]:
    ...
    return {
        ...
        "intent": {
            ...
            "target_users": intent.get("target_users", ["Budui operator"]),
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Export compact Skill IR for a Budui skill.")
